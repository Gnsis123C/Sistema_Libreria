...
-- Tiempo de generación: 21-10-2025 a las 20:50:07
...
(62, 12, 1, '', '1', '1', '1', '1', '1', NULL, '2025-10-21 03:54:35', NULL),
...
(65, 12, 4, '', '1', '1', '1', '1', '1', NULL, '2025-10-21 03:54:35', NULL),
...
DELIMITER $$
CREATE TRIGGER `UPDATE_STOCK_DELETE_venta` AFTER DELETE ON `detalle_venta` FOR EACH ROW UPDATE producto SET stock_usado = stock_usado - OLD.cantidad WHERE idproducto = OLD.idproducto
$$
DELIMITER ;
...
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `anadir_num_factura`;
DELIMITER $$
CREATE TRIGGER `anadir_num_factura` AFTER INSERT ON `venta` FOR EACH ROW UPDATE venta SET numero_factura = LPAD(NEW.idventa, 5, '0') WHERE idventa = NEW.idventa
$$
DELIMITER ;
