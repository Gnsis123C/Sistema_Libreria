...
-- Tiempo de generación: 22-10-2025 a las 03:56:44
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `aplicar_fifo_compra`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `aplicar_fifo_compra` (IN `p_iddetalle_venta` INT, IN `p_idproducto` INT, IN `p_cantidad` INT)   BEGIN
    DECLARE v_restante INT DEFAULT p_cantidad;
    DECLARE v_iddetalle_compra INT;
    DECLARE v_disponible INT;
    DECLARE done INT DEFAULT 0;

    -- Cursor para obtener los registros FIFO de detalle_compra
    DECLARE cur CURSOR FOR
        SELECT iddetalle_compra, (cantidad - IFNULL(venta_usado_cantidad, 0)) AS disponible
        FROM detalle_compra
        WHERE idproducto = p_idproducto
          AND (cantidad - IFNULL(venta_usado_cantidad, 0)) > 0
    ...
    read_loop: LOOP
        FETCH cur INTO v_iddetalle_compra, v_disponible;
        IF done = 1 THEN
            LEAVE read_loop;
        END IF;

        IF v_restante >= v_disponible THEN
            -- Consumimos todo el lote
            UPDATE detalle_compra
               SET venta_usado_cantidad = cantidad
             WHERE iddetalle_compra = v_iddetalle_compra;

            -- Insertamos el registro en inventario_venta
            ...
            SET v_restante = v_restante - v_disponible;

        ELSE
            -- Consumimos parcialmente el lote
            UPDATE detalle_compra
               SET venta_usado_cantidad = IFNULL(venta_usado_cantidad, 0) + v_restante
             WHERE iddetalle_compra = v_iddetalle_compra;

            -- Insertamos el registro parcial en inventario_venta
            INSERT INTO inventario_venta (
                iddetalle_compra,
                iddetalle_venta,
                cantidad,
...
(12, 3, 1, '2025-10-20', '1', '2025-10-22 03:33:54', '2025-10-22 03:33:54', NULL),
(11, 3, 1, '2025-10-20', '1', '2025-10-22 03:03:19', '2025-10-22 03:03:19', NULL),
(10, 3, 1, '2025-10-20', '1', '2025-10-22 03:03:11', '2025-10-22 03:03:11', NULL);
...
(11, 11, 2, 1, 15, 15, '1', '2025-10-22 03:03:19', '2025-10-22 03:03:19', NULL, 11),
(12, 12, 2, 1, 15, 12, '1', '2025-10-22 03:33:54', '2025-10-22 03:33:54', NULL, 0),
(10, 10, 2, 1, 15, 5, '1', '2025-10-22 03:03:11', '2025-10-22 03:03:11', NULL, 5);
...
IF NEW.estado = '1' AND ( NEW.venta_usado_cantidad = OLD.venta_usado_cantidad ) THEN
UPDATE producto SET stock = stock + NEW.cantidad WHERE idproducto = NEW.idproducto;
END IF;
...
(95, 12, 8, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(94, 12, 7, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(93, 12, 6, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(105, 1, 8, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(104, 1, 7, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(103, 1, 6, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(85, 13, 8, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(84, 13, 7, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(83, 13, 6, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(102, 1, 5, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(101, 1, 4, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(100, 1, 3, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(99, 1, 2, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(98, 1, 1, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(92, 12, 5, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(91, 12, 4, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(90, 12, 3, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(89, 12, 2, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(88, 12, 1, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(82, 13, 5, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(81, 13, 4, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(80, 13, 3, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(79, 13, 2, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(78, 13, 1, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(86, 13, 9, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(87, 13, 10, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(96, 12, 9, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(97, 12, 10, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(106, 1, 9, '', '1', '1', '1', '1', '1', NULL, NULL, NULL),
(107, 1, 10, '', '1', '1', '1', '1', '1', NULL, NULL, NULL);
...
INSERT INTO `detalle_venta` (`iddetalle_venta`, `idventa`, `idproducto`, `precio_venta`, `iva`, `cantidad`, `estado`, `temporada`, `created_at`, `updated_at`, `deleted_at`, `iddetalle_compra`) VALUES
(7, 11, 2, 0.35, 15, 16, '1', 'no', '2025-10-22 03:03:37', '2025-10-22 03:03:37', NULL, 0);

--
-- Disparadores `detalle_venta`
--
DROP TRIGGER IF EXISTS `UPDATE_STOCK_DELETE_venta`;
DELIMITER $$
CREATE TRIGGER `UPDATE_STOCK_DELETE_venta` AFTER DELETE ON `detalle_venta` FOR EACH ROW BEGIN 
UPDATE producto SET stock_usado = stock_usado - OLD.cantidad WHERE idproducto = OLD.idproducto;

DELETE FROM inventario_venta WHERE iddetalle_venta = OLD.iddetalle_venta;
END
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `anadir_num_stock_venta`;
DELIMITER $$
CREATE TRIGGER `anadir_num_stock_venta` AFTER INSERT ON `detalle_venta` FOR EACH ROW BEGIN

UPDATE producto SET stock_usado = stock_usado + NEW.cantidad WHERE idproducto = NEW.idproducto;

call aplicar_fifo_compra(NEW.iddetalle_venta, NEW.idproducto, NEW.cantidad);
END
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `editar_stock_producto_venta`;
DELIMITER $$
CREATE TRIGGER `editar_stock_producto_venta` AFTER UPDATE ON `detalle_venta` FOR EACH ROW BEGIN
...
CREATE TABLE IF NOT EXISTS `inventario_venta` (
  `idinventario_Venta` int NOT NULL AUTO_INCREMENT,
  `iddetalle_compra` int NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`idinventario_Venta`)
...
INSERT INTO `inventario_venta` (`idinventario_Venta`, `iddetalle_compra`, `iddetalle_venta`, `cantidad`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2, 4, 3, '2025-10-21 21:41:10', '2025-10-21 21:41:10', NULL),
(2, 3, 4, 48, '2025-10-21 21:41:10', '2025-10-21 21:41:10', NULL),
(3, 6, 5, 10, '2025-10-21 21:52:51', '2025-10-21 21:52:51', NULL),
(4, 7, 5, 24, '2025-10-21 21:52:51', '2025-10-21 21:52:51', NULL),
(5, 8, 6, 15, '2025-10-21 22:00:33', '2025-10-21 22:00:33', NULL),
(6, 9, 6, 1, '2025-10-21 22:00:33', '2025-10-21 22:00:33', NULL),
(7, 10, 7, 5, '2025-10-21 22:03:37', '2025-10-21 22:03:37', NULL),
(8, 11, 7, 11, '2025-10-21 22:03:37', '2025-10-21 22:03:37', NULL);

--
-- Disparadores `inventario_venta`
--
DROP TRIGGER IF EXISTS `actualizar_venta_usado_cantidad_compra`;
DELIMITER $$
CREATE TRIGGER `actualizar_venta_usado_cantidad_compra` AFTER DELETE ON `inventario_venta` FOR EACH ROW BEGIN

UPDATE detalle_compra SET venta_usado_cantidad = venta_usado_cantidad - OLD.cantidad WHERE iddetalle_compra = OLD.iddetalle_compra;
...
(9, 'compra', '1', NULL, NULL, NULL),
(10, 'venta', '1', NULL, NULL, NULL);
...
(2, 1, 2, '7701234567890', 'LAPICERO BIC AZUL CRISTAL', 0.35, 32, 10, 'uploads/2025/10/18/trans_imagen_recortada_68f3a5d225b1f.png', '<p>Lapicero de tinta azul con punta media de 1.0 mm. Ideal para uso escolar y de oficina.</p>', '1', '2025-10-18 09:36:04', '2025-10-20 22:54:22', NULL, 'lapicero-bic-azul-cristal', 16);
...
INSERT INTO `venta` (`idventa`, `idusuario`, `idpersona`, `fecha`, `numero_factura`, `precio_total`, `estado`, `created_at`, `updated_at`, `deleted_at`) VALUES
(11, 1, 1, '2025-10-22', '000011', 5.6, '1', '2025-10-22 03:03:37', '2025-10-22 03:03:37', NULL);

--
-- Disparadores `venta`
--
DROP TRIGGER IF EXISTS `ELIMINAR_DETALLE_venta`;
DELIMITER $$
CREATE TRIGGER `ELIMINAR_DETALLE_venta` AFTER DELETE ON `venta` FOR EACH ROW DELETE FROM detalle_venta WHERE idventa = OLD.idventa
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `editar_detalle_venta`;
DELIMITER $$
CREATE TRIGGER `editar_detalle_venta` AFTER UPDATE ON `venta` FOR EACH ROW BEGIN
    IF NEW.deleted_at IS NOT NULL THEN
