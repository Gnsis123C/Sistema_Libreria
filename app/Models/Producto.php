...
class Producto extends Model
{
    ...
    protected $allowedFields    = ['idproducto','idcategoria','idempresa','codigo_barras','nombre','precio_venta','stock','stock_minimo','imagen','descripcion','estado','slug','stock_usado'];
