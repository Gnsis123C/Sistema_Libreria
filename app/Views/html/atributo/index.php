    ...
    <!-- Default box -->
     <div class="d-flex justify-content-between mb-2">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'':'active' ?>" aria-current="page" href="<?= base_url(route_to('atributo')) ?>">Registros (<?= $registros_no_eliminados ?>)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'active':'' ?>" href="<?= base_url(route_to('atributo')) ?>?papelera=1">Eliminados (<?= $registros_eliminados ?>)</a>
            </li>
        </ul>
        <a class="btn btn-success" href="<?= base_url(route_to('atributo.crear')) ?>">
...
<script type="text/javascript">
    var datatable;
    $(function(){
        var column = ['Nombre','Empresa vinculado','Estado'];
        ...
        datatable = $('#listartable').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    url: '<?php echo base_url(route_to('atributo.actions')); ?>',
                    "type": "POST",
                    "data": function (d) {
                ...
                columns: [
                  { 
                      "data": "nombre", "name":"atributo.nombre", "render": function (d, t, f) {
                            return d;
                        },
                        sDefaultContent: "",
                        className: 'gradeA',
                  ...
                  { 
                      "data": "estado", "name":"atributo.estado", "render": function (d, t, f) {
                          return d;
                      },
                      sDefaultContent: "",
                      className: 'gradeA',
