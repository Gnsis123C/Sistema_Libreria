    ...
    <!-- Default box -->
     <div class="d-flex justify-content-between mb-2">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'':'active' ?>" aria-current="page" href="<?= base_url(route_to('empresa')) ?>">Registros (<?= $registros_no_eliminados ?>)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'active':'' ?>" href="<?= base_url(route_to('empresa')) ?>?papelera=1">Eliminados (<?= $registros_eliminados ?>)</a>
            </li>
        </ul>
        <a class="btn btn-success" href="<?= base_url(route_to('empresa.crear')) ?>">
...
<script type="text/javascript">
    var datatable;
    $(function(){
        var column = ['Nombre','Dirección','Logo','Estado'];
        ...
        datatable = $('#listartable').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    url: '<?php echo base_url(route_to('empresa.actions')); ?>',
                    "type": "POST",
                    "data": function (d) {
                ...
                columns: [
                  { 
                      "data": "nombre", "name":"empresa.nombre", "render": function (d, t, f) {
                          return d;
                      },
                      sDefaultContent: "",
                      className: 'gradeA',
                  ...
                  { 
                      "data": "direccion", "name":"empresa.direccion", "render": function (d, t, f) {
                            return d;
                        },
                        sDefaultContent: "",
                        className: 'gradeA',
                  ...
                  { 
                      "data": "logo", "name":"empresa.logo", "render": function (d, t, f) {
                        const image = `<?= base_url() ?>uploads/img/<?= session('usuario')['usuario'] ?>/${d}`;
                  ...
                  { 
                      "data": "estado", "name":"empresa.estado", "render": function (d, t, f) {
                          return d;
                      },
                      sDefaultContent: "",
                      className: 'gradeA',
