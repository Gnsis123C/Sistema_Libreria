    ...
    <!-- Default box -->
     <div class="d-flex justify-content-between mb-2">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'':'active' ?>" aria-current="page" href="<?= base_url(route_to('marca')) ?>">Registros (<?= $registros_no_eliminados ?>)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= isset($_GET['papelera'])?'active':'' ?>" href="<?= base_url(route_to('marca')) ?>?papelera=1">Eliminados (<?= $registros_eliminados ?>)</a>
            </li>
        </ul>
        <a class="btn btn-success" href="<?= base_url(route_to('marca.crear')) ?>">
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        datatable = $('#listartable').DataTable({
                ...
                serverSide: true,
                "ajax": {
                    url: '<?php echo base_url(route_to('marca.actions')); ?>',
                    "type": "POST",
                    "data": function (d) {
                ...
                columns: [
                  ...
                  { 
                      "data": "nombre", "name":"marca.nombre", "render": function (d, t, f) {
                            return d;
                        },
                        sDefaultContent: "",
                        className: 'gradeA',
                  ...
                  { 
                      "data": "estado", "name":"marca.estado", "render": function (d, t, f) {
                          return d;
                      },
                      sDefaultContent: "",
                      className: 'gradeA',
