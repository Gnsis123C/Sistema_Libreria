...
<script type="text/javascript">
    $(function() {
                            ...
                            email: {
                                validators: {
                                    ...
                                    remote: {
                                        ...
                                        url: '<?= base_url(route_to('usuario.validar.email')) ?>',
                                        type: 'GET',
                            ...
                            usuario: {
                                validators: {
                                    ...
                                    remote: {
                                        ...
                                        url: '<?= base_url(route_to('usuario.validar.usuario')) ?>',
                                        type: 'GET',
                                        data: function(validator) {
                                            return {
                                                "<?= csrf_token() ?>": "<?= csrf_hash() ?>",
                ...
                API.enviar($form.serialize())
                    .done(function(data) {
                        if (data.resp) {
                            ...
                            setTimeout(() => window.location = '<?= base_url(route_to('usuario')) ?>', 2500);
                        } else {
            ...
            $('#cancelar').on('click', function() {
                window.location = '<?= base_url(route_to('usuario')) ?>';
            });
        });
</script>
