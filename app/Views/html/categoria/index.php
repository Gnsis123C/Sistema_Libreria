    ...
    <div class="col-12 px-0 px-sm-3">
        <div class="mb-5">
            <p class="text-muted h6 fw-light">
                Gestión de categorías del sistema, para uso en productos.
            </p>
        </div>
        <!-- Tables Row -->
        <div class="row g-4">
            <div class="col-xl-12">
                <div class="d-flex justify-content-between align-items-sm-end">
                    ...
                    <ul class="nav nav-tabs border-bottom-0 d-none d-sm-flex">
                        <li class="nav-item">
                            <a class="nav-link <?= isset($_GET['papelera']) ? '' : 'active' ?>" aria-current="page" href="<?= base_url(route_to('categoria')) ?>">
                                Registros activos (<?= $registros_no_eliminados ?>)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= !isset($_GET['papelera']) ? '' : 'active' ?>" href="<?= base_url(route_to('categoria')) ?>?papelera=1">
                    ...
                    <div class="dropdown ms-sm-auto mb-1">
                        <a class="btn btn-success rounded-0" href="<?= base_url(route_to('categoria.crear')) ?>">
